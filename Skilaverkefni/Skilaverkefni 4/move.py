...
player_position = int(input('Input a position between 1 and 10: ')) -1

if player_position < 0 or player_position > 9:
    print('Invalid input.')
    player_position = int(input('Input a position between 1 and 10: '))
...
moving_direction = input('Input your choice: ')
